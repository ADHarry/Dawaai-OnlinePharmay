    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        ?>
            ...
            <form action="admin.php" method="POST">
                <div class="form-group">
                    <label>Name</label>
                    <input pattern="[A-Za-z_]{1,15}" type="text" class="form-control" placeholder="<?php echo $data[0]['admin_name'] ?>" name="admin_name">
                    <div class="form-text">please enter the name in range(1-30) character/s , special character & numbers not allowed !</div>
                </div>
                <br>
        ...
        ?>
            ...
            <form action="admin.php" method="POST">
                <div class="form-group">
                    <label>Name</label>
                    <input pattern="[A-Za-z_]{1,15}" type="text" class="form-control" placeholder="First name" name="admin_name">
                    <div class="form-text">please enter the name in range(1-30) character/s , special character & numbers not allowed !</div>
                </div>
                <br>
                <div class="form-group">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $data[$i]['admin_name'] ?></td>
